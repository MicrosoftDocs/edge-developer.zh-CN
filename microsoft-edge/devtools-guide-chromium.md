...
如果您要签出新的 Microsoft Edge，并且以前是在 Microsoft Edge \ (EdgeHTML \ ) 中开发的，现在您有了一些非常好的工具，可让您在 Microsoft Edge 中更轻松、更快地构建和测试您的网站！  
...
*   **审核**面板 \ (现在重命名**Lighthouse**\ ) 以运行网站审核。  审核结果可帮助你通过以下方式改善网站的质量。  
