...
*   <span data-ttu-id="345fa-139">Source \*\*\*\* 行将告知您当前正在运行的服务工作线程的安装时间。</span><span class="sxs-lookup"><span data-stu-id="345fa-139">The **Source** line tells you when the currently running service worker was installed.</span></span>  <span data-ttu-id="345fa-140">链接是服务工作者的源文件的名称。</span><span class="sxs-lookup"><span data-stu-id="345fa-140">The link is the name of the source file of the service worker.</span></span>  <span data-ttu-id="345fa-141">选择链接将你发送到服务工作者的源。</span><span class="sxs-lookup"><span data-stu-id="345fa-141">Choosing on the link sends you to the source of the service worker.</span></span>  
