...
---
# 调试器域 - DevTools 协议版本 0.2 (EdgeHTML)   
...
### setBlackboxPatterns
<span><b>实验。 </b></span>将以前的黑盒模式替换为传递的黑色框模式。 使用与其中一种模式匹配的 URL 强制后端跳过脚本中的单步执行/暂停。 调试器将尝试通过多次执行"步骤"来退出黑盒脚本，如果失败，最后会采取"退出"。
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>reason</td>
            <td><code class="flyout">string</code> <br/> <i>允许的值：断点、步骤、异常、其他、EventListener</i></td>
            <td>暂停原因。</td>
        </tr>
        <tr>
            <td>数据 <br/> <i>可选</i></td>
        ...
        <tr>
            <td>asyncStackTrace <br/> <i>可选</i></td>
            <td><!--  <a href="#stacktrace">  --><code class="flyout">StackTrace</code><!--  </a>  --></td>
            <td>JavaScript 异步堆栈跟踪。</td>
        </tr>
    </tbody>
</table>
</p>
...
<table>
    ...
    <tbody>
        <tr>
            <td>类型</td>
            <td><code class="flyout">string</code> <br/> <i>允许的值：global、local、with、closure、catch、block、script、eval、module、return</i></td>
            <td>范围类型。</td>
        </tr>
        <tr>
            <td>object</td>
