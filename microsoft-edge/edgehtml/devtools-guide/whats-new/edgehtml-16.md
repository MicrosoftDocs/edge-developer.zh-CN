...
<span data-ttu-id="6f099-117">可以从"元素"或"调试器"面板中的**DOM**断点窗格管理你的分解断点。</span><span class="sxs-lookup"><span data-stu-id="6f099-117">You can manage your mutation breakpoints from the **DOM breakpoints** pane in the **Elements** or **Debugger** panels.</span></span>
