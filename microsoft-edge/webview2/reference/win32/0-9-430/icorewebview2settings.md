...
---
# 0.9.430-接口 ICoreWebView2Settings 
...
[get_AreRemoteObjectsAllowed](#get_areremoteobjectsallowed) | AreRemoteObjectsAllowed 属性用于控制是否可以从 web 视图中的页面访问远程对象。
...
默认值为 TRUE。 当禁用时，用户将无法使用 ctrl +/-或 ctrl + 鼠标滚轮进行缩放，但可以通过 put_ZoomFactor API 设置缩放。
