...
---
# 0.8.355-接口 IWebView2ProcessFailedEventHandler 
...
> 公共 HRESULT[调用](#invoke)（[IWebView2WebView](IWebView2WebView.md) * web 视图，[IWebView2ProcessFailedEventArgs](IWebView2ProcessFailedEventArgs.md) * 参数）
