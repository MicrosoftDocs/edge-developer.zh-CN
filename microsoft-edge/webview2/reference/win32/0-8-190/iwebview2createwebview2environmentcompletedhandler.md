...
---
# 0.8.355-接口 IWebView2CreateWebView2EnvironmentCompletedHandler 
...
调用方实现此接口以接收通过 CreateWebView2Environment 创建的 WebView2Environment。
...
> 公共 HRESULT[调用](#invoke)（hresult 结果，[IWebView2Environment](IWebView2Environment.md) * webViewEnvironment）
