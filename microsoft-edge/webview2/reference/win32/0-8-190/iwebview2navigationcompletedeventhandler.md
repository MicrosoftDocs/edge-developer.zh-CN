...
---
# 0.8.355-接口 IWebView2NavigationCompletedEventHandler 
...
> 公共 HRESULT[调用](#invoke)（[IWebView2WebView](IWebView2WebView.md) * web 视图，[IWebView2NavigationCompletedEventArgs](IWebView2NavigationCompletedEventArgs.md) * 参数）
