...
---
# 0.8.355-接口 IWebView2NavigationStartingEventHandler 
...
> 公共 HRESULT[调用](#invoke)（[IWebView2WebView](IWebView2WebView.md) * web 视图，[IWebView2NavigationStartingEventArgs](IWebView2NavigationStartingEventArgs.md) * 参数）
