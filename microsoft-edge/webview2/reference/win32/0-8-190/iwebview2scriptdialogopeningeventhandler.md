...
---
# 0.8.355-接口 IWebView2ScriptDialogOpeningEventHandler 
...
> 公共 HRESULT[调用](#invoke)（[IWebView2WebView](IWebView2WebView.md) * web 视图，[IWebView2ScriptDialogOpeningEventArgs](IWebView2ScriptDialogOpeningEventArgs.md) * 参数）
