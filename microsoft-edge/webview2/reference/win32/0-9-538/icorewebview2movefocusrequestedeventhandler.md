...
---
# 0.9.579-接口 ICoreWebView2MoveFocusRequestedEventHandler 
...
调用方实现此方法以接收 MoveFocusRequested 事件。
...
> public HRESULT [调用](#invoke) ([ICoreWebView2Controller](icorewebview2controller.md) * sender、 [ICoreWebView2MoveFocusRequestedEventArgs](icorewebview2movefocusrequestedeventargs.md) * 参数) 
