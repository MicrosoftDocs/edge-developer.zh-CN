...
[ZoomFactorChanged](#zoomfactorchanged) | 当 Web 视图的 ZoomFactor 属性更改时，将触发 ZoomFactorChanged。
...
在引发 MoveFocusRequested 事件的情况下，当 MoveFocusRequested 事件引发时，焦点仍在 Web 视图上。 仅当应用的 MoveFocusRequested 事件的代码或默认操作设置焦点离开 Web 视图时，LostFocus 才会随后引发。
...
当 Web 视图的 ZoomFactor 属性更改时，将触发 ZoomFactorChanged。
...
> public void [MoveFocus](#movefocus) ([CoreWebView2MoveFocusReason](./namespace-microsoft-web-webview2-core.md) 理由) 
...
> 公共 void [NotifyParentWindowPositionChanged](#notifyparentwindowpositionchanged) ( # A1
...
> public void [SetBoundsAndZoomFactor](#setboundsandzoomfactor) (矩形边界，双 ZoomFactor) 
