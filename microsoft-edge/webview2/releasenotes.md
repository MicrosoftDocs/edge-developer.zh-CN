...
*   有关生成 Windows Forms 应用的信息，请导航到[Windows Forms 入门][Webview2GettingstartedWinforms]指南和 WebView2 Windows [Forms Reference][DotnetApiMicrosoftWebWebview2Winforms] for Windows Forms specific APIs。  
...
[Webview2GettingstartedWinforms]: ./gettingstarted/winforms.md "Windows Forms 应用中的 WebView2 |Microsoft Docs"  
