...
1.  在 **MainWindow.xaml.cs**中，更新你的构造函数并创建 `InitializeAsync` 函数，如以下代码片段所示。  `InitializeAsync`函数会等待[EnsureCoreWebView2Async](/dotnet/api/microsoft.web.webview2.wpf.webview2.ensurecorewebview2async) ，因为它的初始化 `CoreWebView2` 是异步的。  
...
*   有关 WebView2 Api 的更多详细信息，请参阅 [API 参考](/dotnet/api/microsoft.web.webview2.wpf.webview2)。  
